...
function addStruct(htmlClass, x, color, width, height) {
    ...
    if(htmlClass=="addHere")
        var overlayDiv = "<div class='overlay'><svg width='" + width + "' height='" + height + "'><defs><pattern id='pattern-stripe' width='4' height='4' patternUnits='userSpaceOnUse' patternTransform='rotate(45)'><rect width='2' height='4' transform='translate(0,0)' fill='white'></rect></pattern><mask id='mask-stripe'><rect x='0' y='0' width='100%' height='100%' fill='url(#pattern-stripe)' /></mask></defs><rect class='struct rect" + x + "' width='500' height='500' fill='" + color + "'></svg></div>"
    if(htmlClass=="addHere2")
        var overlayDiv = "<div class='overlay2'><svg width='" + width + "' height='" + height + "'><defs><pattern id='pattern-stripe' width='4' height='4' patternUnits='userSpaceOnUse' patternTransform='rotate(45)'><rect width='2' height='4' transform='translate(0,0)' fill='white'></rect></pattern><mask id='mask-stripe'><rect x='0' y='0' width='100%' height='100%' fill='url(#pattern-stripe)' /></mask></defs><rect class='struct rect" + x + "' width='500' height='500' fill='" + color + "'></svg></div>"
    if(htmlClass=="addHere3")
        var overlayDiv = "<div class='overlay3'><svg width='" + width + "' height='" + height + "'><defs><pattern id='pattern-stripe' width='4' height='4' patternUnits='userSpaceOnUse' patternTransform='rotate(45)'><rect width='2' height='4' transform='translate(0,0)' fill='white'></rect></pattern><mask id='mask-stripe'><rect x='0' y='0' width='100%' height='100%' fill='url(#pattern-stripe)' /></mask></defs><rect class='struct rect" + x + "' width='500' height='500' fill='" + color + "'></svg></div>"
...
function getIncomingMode() {
    ...
    $("#mode1").remove();
    $("#mode2").remove();
    newdiv.innerHTML = "<div id='mode1'><i class='fa fa-arrow-right' aria-hidden='true'></i><u>" + mFor1x + " + " + mFor1y + "i<br><i class='fa fa-arrow-right' aria-hidden='true'></i>" + mFor2x + " + " + mFor2y + "i</u></div>";
