        ...
        $stateProvider
          .state('app', {
            ...
            .state('app.dashboard', {
              ...
              data : { title: 'Electromagnetic Wave Scattering' },
              controller: "ChartCtrl",
              resolve: load(['scripts/controllers/chart.js', 'scripts/dynamic.js', 'scripts/loader.js', 'scripts/emScattering.js', 'scripts/numeric-1.2.6.js'])
            })
